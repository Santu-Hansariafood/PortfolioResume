...
import PROFILE_PIC from "../assets/mydp.png";
...
const Hero = () => {
  const {
    ...
    email,
    skills,
    socialLinks, // Assuming you have socialLinks object in your PROFILE_DATA
  } = PROFILE_DATA;
  return (
    <section
    ...
    >
      ...
      <div className="flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]">
        <div className="w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border-blue-950 p-6">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaGithub className="text-lg md:text-xl" />
            </a>
            <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaLinkedin className="text-lg md:text-xl" />
            </a>
            <a href={socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaXTwitter className="text-lg md:text-xl" />
            </a>
            <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaFacebook className="text-lg md:text-xl" />
            </a>
            <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
              <FaInstagram className="text-lg md:text-xl" />
            </a>
            <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-2 rounded">
